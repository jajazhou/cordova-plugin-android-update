...
public class MsgBox {
  ...
  public Dialog showNoticeDialog(UpdateDialog.OnCenterItemClickListener onClickListener, Version version) {
    if (noticeDialog == null) {
      ...
      this.noticeDialog = new UpdateDialog(this.mContext,version.getForce(),
    ...
    this.noticeDialog.setCanceledOnTouchOutside(version.getForce()==0);
    ...
    tvCode.setText("升级到新版本："+version.getRemoteName());
